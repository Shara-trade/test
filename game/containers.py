...
class ContainerSystem:
    ...
    @staticmethod
    def generate_rewards(container_type: str) -> Dict:
        """
        Сгенерировать награды за открытие контейнера.
        Согласно таблице шансов из Update.txt.
        
        Args:
            container_type: Тип контейнера (common, rare, epic, mythic, legendary)
        
        Returns:
            Dict с ключами: container_type, resources, materials
        """
        from game.materials import MaterialSystem, MaterialGroup
        
        container_info = ContainerSystem.CONTAINER_INFO.get(ContainerType(container_type))
